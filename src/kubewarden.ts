...
export function transform_kubewarden(PSP: k8s.V1beta1PodSecurityPolicy): object[] {
  ...
  if ( !PSP.spec?.privileged)
    policies.push(mod.kubewarden_policy_helper(
      'privileged',
      'registry://ghcr.io/kubewarden/policies/pod-privileged:v1.0.13',
    ))

  if (PSP.spec?.readOnlyRootFilesystem === true)
    policies.push(mod.kubewarden_policy_helper(
      'readOnlyRootFilesystem',
      'registry://ghcr.io/kubewarden/policies/readonly-root-filesystem-psp:v1.0.13',
    ))

  policies.push(mod.kubewarden_policy_helper(
    'hostnamespaces',
    'registry://ghcr.io/kubewarden/policies/host-namespaces-psp:v1.0.1',
    {
  ...
  if (!PSP.spec?.volumes?.includes('*'))
    policies.push(mod.kubewarden_policy_helper(
      'volumes',
      'registry://ghcr.io/kubewarden/policies/volumes-psp:v1.1.10',
  ...
  if (PSP.metadata?.annotations && PSP.metadata.annotations['apparmor.security.beta.kubernetes.io/allowedProfileNames'])
    policies.push(mod.kubewarden_policy_helper(
      'apparmor',
      'registry://ghcr.io/kubewarden/policies/apparmor-psp:v1.0.14',
  ...
  if (PSP.metadata?.annotations && PSP.metadata.annotations['seccomp.security.alpha.kubernetes.io/allowedProfileNames']) {
    ...
    policies.push(mod.kubewarden_policy_helper(
      'seccomp',
      'registry://ghcr.io/kubewarden/policies/seccomp-psp:v1.0.15',
      {
  ...
  if (PSP.spec?.seLinux?.rule === 'MustRunAs')
    policies.push(mod.kubewarden_policy_helper(
      'seLinux',
      'registry://ghcr.io/kubewarden/policies/selinux-psp:v1.0.6',
  ...
  if (PSP.spec?.allowedCapabilities || PSP.spec?.requiredDropCapabilities || PSP.spec?.defaultAddCapabilities)
    policies.push(mod.kubewarden_policy_helper(
      'capabilities',
      'registry://ghcr.io/kubewarden/policies/capabilities-psp:v1.0.13',
      {
  ...
  if (PSP.spec?.allowedFlexVolumes)
    policies.push(mod.kubewarden_policy_helper(
      'allowedFlexVolumes',
      'registry://ghcr.io/kubewarden/policies/flexvolume-drivers-psp:v1.0.17',
  ...
  if (PSP.spec?.allowedHostPaths)
    policies.push(mod.kubewarden_policy_helper(
      'allowedHostPaths',
      'registry://ghcr.io/kubewarden/policies/hostpaths-psp:v1.1.10',
  ...
  if (PSP.spec?.allowedProcMountTypes)
    policies.push(mod.kubewarden_policy_helper(
      ...
      'registry://ghcr.io/kubewarden/policies/allowed-proc-mount-types-psp:v1.0.15',
  ...
  if (PSP.spec?.allowedUnsafeSysctls || PSP.spec?.forbiddenSysctls)
    policies.push(mod.kubewarden_policy_helper(
      'allowedProcMountTypes',
      'registry://ghcr.io/kubewarden/policies/sysctl-psp:v1.0.14',
      {
  ...
  if (PSP.spec?.runAsUser?.rule !== 'RunAsAny' ||
    ...
    policies.push(mod.kubewarden_policy_helper(
      'usergroup',
      'registry://ghcr.io/kubewarden/policies/user-group-psp:v1.1.5',
      {
  ...
  if (PSP.spec?.fsGroup && PSP.spec?.fsGroup?.rule !== 'RunAsAny')
    policies.push(mod.kubewarden_policy_helper(
      'fsGroup',
      'registry://ghcr.io/kubewarden/policies/allowed-fsgroups-psp:v1.0.12',
      PSP.spec?.fsGroup
    ))
  ...
  if (PSP.spec?.defaultAllowPrivilegeEscalation !== undefined || PSP.spec?.allowPrivilegeEscalation !== undefined)
    policies.push(mod.kubewarden_policy_helper(
      ...
      'registry://ghcr.io/kubewarden/policies/allow-privilege-escalation-psp:v1.0.13',
