...
const defaultKubewardenPolicies = [{ "apiVersion": "policies.kubewarden.io/v1", "kind": "ClusterAdmissionPolicy", "metadata": { "name": "psp-privileged" }, "spec": { "module": "registry://ghcr.io/kubewarden/policies/pod-privileged:v0.3.2", "mutating": false, "rules": [{ "apiGroups": [""], "apiVersions": ["v1"], "operations": ["CREATE", "UPDATE"], "resources": ["pods"] }], "settings": null } }, { "apiVersion": "policies.kubewarden.io/v1", "kind": "ClusterAdmissionPolicy", "metadata": { "name": "psp-hostnamespaces" }, "spec": { "module": "registry://ghcr.io/kubewarden/policies/host-namespaces-psp:v0.1.6", "mutating": false, "rules": [{ "apiGroups": [""], "apiVersions": ["v1"], "operations": ["CREATE", "UPDATE"], "resources": ["pods"] }], "settings": { "allow_host_ipc": false, "allow_host_network": false, "allow_host_pid": false, "allow_host_ports": undefined } } }]
